...
const ProductsPage = () => {
  ...
  return (
    <AdminLayout title={'Productos'} pageDescription={'Mantenimiento de productos'} icon={<CategoryOutlined />}>
        
        <Box display='flex' justifyContent='end' sx={{mb: 2}}>
            <Button startIcon={<AddOutlined></AddOutlined>} color='secondary' href='/admin/products/new'>
                Crear producto
            </Button>
